...
public class VariableScope {
    ...
    public void printOutputMethod() {
        ...
        // ✅ Print the output of the Instance Variable and Static Variable in 2 separate lines
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n---- Object 2 ----");
        // ✅ Call printOutputMethod using Object 2
        obj2.printOutputMethod();

        System.out.println("\n---- Object 1 Again ----");
        // ✅ Call printOutputMethod using Object 1
        obj1.printOutputMethod();

        System.out.println("\nThe program is complete. Variable scope behavior demonstrated.");
    }
}
